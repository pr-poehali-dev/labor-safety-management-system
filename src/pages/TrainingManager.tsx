  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold">Обучение и инструктажи</h1>
            </div>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card>
          <CardHeader>
            <CardTitle>Модуль обучения и инструктажей</CardTitle>
            <CardDescription>Планирование и контроль обучения сотрудников</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <Icon name="GraduationCap" size={64} className="mx-auto text-green-600 mb-4" />
