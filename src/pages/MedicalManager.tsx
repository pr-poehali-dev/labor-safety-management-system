  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold">Медицинские осмотры</h1>
            </div>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card>
          <CardHeader>
            <CardTitle>Модуль медицинских осмотров</CardTitle>
            <CardDescription>Планирование и контроль медосмотров</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <Icon name="Stethoscope" size={64} className="mx-auto text-red-600 mb-4" />
