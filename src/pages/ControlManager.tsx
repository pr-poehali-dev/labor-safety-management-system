  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold">Контроль требований ОТ</h1>
            </div>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card>
          <CardHeader>
            <CardTitle>Модуль контроля требований</CardTitle>
            <CardDescription>Проверки и предписания по охране труда</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              <Icon name="Search" size={64} className="mx-auto text-teal-600 mb-4" />
